import { Card, Column, Row, Text, Icon } from "@once-ui-system/core";
...
export default function MusicCard({ title, description, platform, url, size = "medium" }: MusicCardProps) {
  ...
  const cardHeight = size === "large" ? "200px" : size === "medium" ? "150px" : "120px";
